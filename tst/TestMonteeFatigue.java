...
class TestMonteeFatigue extends TestPassagerAbstrait {
  ...
  public static void main (String[] args) throws TecException {
    ...
    new TestMonteeFatigue().testInstanciation();

    //********* Verifier changement d'etat **************
    System.out.print('.'); nbTest++;
    new TestMonteeFatigue().testGestionEtat();

    //********* Verifier les interactions  *************
    System.out.print('.'); nbTest++;
    new TestMonteeFatigue().testInteractionMontee();

    System.out.println("(" + nbTest + "):OK: " + "tec.MonteeFatigue");
  }
 
  protected PassagerAbstrait creerPassager(String nom, int destination){
    return new MonteeFatigue(nom, destination, (ComportementArret)FabriqueTec.recupererArretCalme());
  }
