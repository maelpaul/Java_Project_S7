...
// N'accepte que les arrets nerveux et passagerSportif
class BusSportif implements Vehicule, Transport  {
  ...
  public BusSportif(int nbPlaceAssise, int nbPlaceDebout) {
    if(nbPlaceAssise < 0){
  ...
  /**
   * Ajoute un passager dans le bus montant dans le bus directement en place assise.
   */
  public void monteeDemanderAssis(Passager p) {
    if (!(p instanceof MonteeSportif))
        return;
  ...
  public String toString(){
    return "BusSportif, jauge assis : " + jaugeAssis + " | jauge debout : " + jaugeDebout;
  }
}
